...
class A {
	//Number : Boolean, Character를 제외한 정수, 실수를 처리하는
		//Byte, Short, Integer, Long, Float, Double
	public <T extends Number> void method1 (T t) {	//extends Number는 Number로 타입 제한을 하는 것
...
class B {
	...
	//T : MyInterface 하위의 구현 클래스가 올 수 있다. 주의 : 타입을 제한할때는 implements가 아닌 extends를 사용.
