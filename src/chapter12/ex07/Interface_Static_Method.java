...
interface A {
	//static 메소드 : 접근제어자 public 생략, 객체 생성 없이 바로 호출해서 사용 가능하다.
		//구현 코드가 있는 메소드
	static void abc() {
