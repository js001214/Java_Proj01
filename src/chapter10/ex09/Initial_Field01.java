...
class Student {
	...
	public void setName(String name) { //String name을 받고 name -> this.name
		this.name = name;
	}
	public int getStuID() {
		return stuID;
	...
	//toString() 재정의 : 객체의 Heap 메모리에 주소값 출력, hashcode로 출력된다. (16진수로)
	//객체 자체를 출력했을때 toString()가작동
	@Override
	public String toString() {	//Object 클래스의 메소드, 모든 자바의 클래스는 Ojbect 상속
		return "Student [name=" + name + ", stuID=" + stuID + ", age=" + age + ", stuAdd=" + stuAdd + ", stuPhone="
				+ stuPhone + ", weight=" + weight + "]";	//string타입으로 리턴
	}
...
public class Initial_Field01 {
	...
	public static void main(String[] args) {
		...
		//	  DTO는 client에게 값을 받아서 DAO에 값을 전송,DAO(Data Access Object) : DataBase에 Insert, Update, Delete
		...
		Student s2 = new Student("이순신", 2222, 30, "서울 강남구","010-1111-1111",85.8,11);
