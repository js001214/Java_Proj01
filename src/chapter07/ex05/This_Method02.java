...
public class This_Method02 {
	...
	public static void main(String[] args) {
		...
		//매개변수 정수 1개인 생성자 호출
		System.out.println("======Aa 클래스의 매개변수 정수1개인 생성자 호출======");
		Aa a2 = new Aa (10);
		a2.print();
		
		//매개변수 정수 2개인 생성자 호출
		System.out.println("======Aa 클래스의 매개변수 정수2개인 생성자 호출======");
		Aa a3 = new Aa (10,20);
		a3.print();
		
		//매개변수 정수 3개인 생성자 호출
		System.out.println("======Aa 클래스의 매개변수 정수3개인 생성자 호출======");
		Aa a4 = new Aa (10,20,30);
		a4.print();
				
		//매개변수 정수 4개인 생성자 호출
		System.out.println("======Aa 클래스의 매개변수 정수4개인 생성자 호출======");
		...
		System.out.println("====Bb 클래스에서 매개변수 정수1개인 생성자 호출====");
		Bb b2 = new Bb(10);
		b2.print();
		
		System.out.println("====Bb 클래스에서 매개변수 정수2개인 생성자 호출====");
		Bb b3 = new Bb(10,20);
		b3.print();
		
		System.out.println("====Bb 클래스에서 매개변수 정수3개인 생성자 호출====");
		Bb b4 = new Bb(10,20,30);
		b4.print();
		
		System.out.println("====Bb 클래스에서 매개변수 정수4개인 생성자 호출====");
