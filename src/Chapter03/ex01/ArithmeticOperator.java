...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		...
		//1. 산술 연산자
		System.out.println( 2 + 3 ); //5             a + b 산술연산
		System.out.println( 2 + "3" ); //"3"은 문자열 //23    //  a + "b"  ab  연결 연산자
		System.out.println( 8 - 5 ); //3  a- b 산술연산
		System.out.println( 7 * 2 );
		System.out.println( 7 / 2 );
		System.out.println( 8 % 5 );	//3  a % b  나머지 값만 출력  
		...
		//3. 증감 연산자 (case 2)
			...
			int value7 = 3;
			int value8 = 4;
			int value9 = 2+ value7-- + ++value8; // --가 뒤에 있으면 value값이 먼저 2+3+5
