...
public class Initial_Value {
	...
	public static void main(String[] args) {
		...
		int value1;
		//System.out.println(value1); //초기값이 없어서 오류 발생
		int[] value2;
		//value2 = new int[3];
		//System.out.println(value2); //오류 발생 : value2의 Heap영역의 주소값이 없다.
		
		int value3 = 0;
		System.out.println(value3);
		int[] value4 = null; //null : 비어있는 상태, 기본자료형에는 사용 할 수 없다.
							 // 참조자료형에서만 사용가능
		
		System.out.println(value4); //value4에 Heap 영역의 주소가 비어있는 상태 : null
		...
		boolean[] arr1 = new boolean[3] ; // 기본값으로 false가 각 방에 들어간다.
