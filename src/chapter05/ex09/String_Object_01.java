...
public class String_Object_01 {
	...
	public static void main(String[] args) {
		...
		//1. String으로 객체 생성 방법 1		<==별도의 주소에 생성됨
		...
		str3 = "안녕하세요"; //수정되는게 아니고 안녕하세요 라는 별도의 Heap 번지를 새로 만듬 ==> String만의 특징
		
		System.out.println(str3);	//안녕하세요
		System.out.println(str4);	//안녕
		
		//배열의 참조 변수: 객체 내부의 값을 수정 할 수 있따.
		int [] arr1=new int[] {3, 4, 5};
		int [] arr2=arr1; // stack공간의 메모리 값을 복사
