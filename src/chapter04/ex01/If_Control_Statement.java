...
public class If_Control_Statement {
	...
	//	1. type 1 : if (조건) { 실행문 : 조건이 참일때 실행; } 
		...
		if (value1 > 3) {
			//조건이 참일때 실행블럭
			System.out.println("실행");		//조건이 참이므로 실행됨
		}
		...
		if (value1 < 3) {
			//조건이 거짓
			System.out.println("실행2");		//조건이 거짓이므로 실행되지 않는다.
		}
		
		
		System.out.println("============={조건이 참일때 실행문}, {} 생략 가능=============");
		//if 조건에서 {}속 실행문이 하나일때 {} 생략 가능
		if (value1 < 3) 
			System.out.println("실행3"); //참일때 1개만 { }가 생력되어서 처리될 수 있다.
		...
		System.out.println("=============if를 사용해서 출력=============");	
			...
			if ( value3 > 90 ) {
				...
				System.out.println("B 학점");		//if문을 빠져나온다. 실행 후 탈출
			}
			else if (value3 >= 70) {
			...
			else if (value3 >=70 && value3 <80 ) {		//if문을 빠져나온다. 실행후 탈출
				System.out.println("C 학점");
			}
